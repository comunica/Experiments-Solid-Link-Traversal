...
psbr csv wins --name 'stats_queries_wins.md' --markdown \
    --overrideCombinationLabels idx,idx-filt,ldp,ldp-idx,ldp-idx-filt \
    --correctnessReference correctnessReference.json \
    combination_4/output combination_7/output combination_10/output combination_13/output combination_16/output
